      ...
      <div className="bg-obsidian min-h-screen pt-20 md:pt-32 pb-20 relative">
               ...
               <div className="w-full lg:w-1/2">
                  ...
                  <div className="flex flex-col gap-4">
                     <button
                        ...
                        className="w-full bg-gold text-obsidian font-bold py-4 px-6 text-center text-sm uppercase tracking-widest hover:bg-gold/90 transition-colors"
                     >
                        Buy Now &mdash; Pay Online
                     </button>
                     <a
                        ...
                        className="w-full bg-transparent border border-[#25D366] text-[#25D366] font-bold py-4 px-6 text-center text-sm uppercase tracking-widest hover:bg-[#25D366] hover:text-obsidian transition-colors flex items-center justify-center gap-3"
                     >
         ...
         {showCheckout && (
            <CheckoutModal
               ...
               size={size}
               grind={grind}
               amountRupees={Math.round(product.price * 100 * (SIZES.find(s => s.label === size)?.multiplier || 1))}
